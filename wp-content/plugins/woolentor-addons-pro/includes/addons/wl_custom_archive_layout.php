...
class Woolentor_Wl_Custom_Archive_Layout_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'same_height_box',
                [
                    'label'         => __( 'Same Height Box ?', 'woolentor-pro' ),
                    'type'          => Controls_Manager::SWITCHER,
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'description'=>__('Only For Grid View Mode','woolentor-pro')
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Grid View action button settings', 'woolentor-pro' ),
                    'type' => Controls_Manager::HEADING,
                    "separator"=>"before"
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .ht-products .ht-product .ht-product-inner .ht-product-image-wrap .ht-product-label' => 'background-color: {{VALUE}} !important;',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                Group_Control_Background::get_type(),
                [
                    'name' => 'product_list_area_background',
                    'label' => __( 'Background', 'woolentor-pro' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .wlshop-list-wrap',
                    'exclude' => ['image'],
    ...
    protected function render( $instance = [] ) {
        ...
        $same_height_box = $settings['same_height_box'];

        ?>
            <div class="<?php echo esc_attr( $wrap_class ); ?> <?php echo $same_height_box == 'yes' ? 'woolentor-product-same-height' : ''; ?>"<?php echo $wrap_attributes; ?>>
